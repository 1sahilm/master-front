...
function Headboardproduct({ response }) {
  ...
  async function addToCarsst() {
    const { data } = await axios.get(`/api/headboard/${response[0]._id}`);
                                  ...
                                  <div className="row">
                                    ...
                                    >
                                      <Image
                                        ...
                                        width={140}
                                        height={100}
                                        src="/assets/images/HeadboardIcon/headboard-icon-01 (1).png"
                                      />
                                      <br />
                                    ...
                                    >
                                      <Image
                                        ...
                                        height={100}
                                        id="img_2"
                                        src="/assets/images/HeadboardIcon/headboard-icon-02.png"
                                      />
                                      <span className="productsize">
                                        3ft Single{" "}
                                        <span>
                                    ...
                                    >
                                      <Image
                                        ...
                                        height={100}
                                        id="img_3"
                                        src="/assets/images/HeadboardIcon/headboard-icon-03.png"
                                      />
                                      <span className="productsize">
                                        4ft Single{" "}
                                        <span>
                                    ...
                                    >
                                      <Image
                                        ...
                                        width={140}
                                        height={100}
                                        src="/assets/images/HeadboardIcon/headboard-icon-04.png"
                                      />
                                      <span className="productsize">
                                        4.6ft Single{" "}
                                        <span>
                                  ...
                                  <div className="row mt-2"> */}
                                    ...
                                    >
                                      <Image
                                        ...
                                        width={140}
                                        height={100}
                                        src="/assets/images/HeadboardIcon/headboard-icon-05.png"
                                      />
                                      <span className="productsize">
                                        5ft Single{" "}
                                        <span>
                      ...
                      <div className="col-md-9 col-xs-9 price-box">
                        <div className="scndbtn">
                          <div className="row">
                            ...
                            <div className="col-md-6">
                              <Checkout
                                addToCartHandler={addToCartHandler}  title={bed?.product_name} base_price={bed?.price} type="headboard" size={bed?.size} bedColor={colorName}
                                price={total}
                              />
                            </div>
                          </div>
...
export async function getServerSideProps(context) {
  ...
  const data = await axios.post("http://localhost:3000/api/headboard/getbeds", {
    method: "product_name",
    value: title,
  });
