...
import LivingroomBox from "../../components/comps/LivingroomBox";
...
function Rockingchairs({response}){
        ...
        <Header/>
          ...
          <div className="container">
              <div className="row text-center ">
                  <h1 className="font-weight-bold mt-6" style={{color:"#0e3f70"}}>Rocking Chairs</h1>
          ...
          <div className="row">
            <div className="size-box">
              <div className="single-box category-icon">
                ...
                <p className="text-center text-blue mt-2">  Armchair </p>
              </div>
              ...
              <div className="single-box category-icon" >
                ...
                <p className="text-center text-blue mt-2">   Chestdrawers </p>
              </div>
              ...
              <div className="single-box category-icon">
                ...
                <p className="text-center text-blue mt-2">  Rockingchairs </p>
              </div>
              ...
              <div className="single-box category-icon">
                ...
                <p className="text-center text-blue mt-2">  Shelf </p>
              </div>
              ...
              <div className="single-box category-icon">
                ...
                <p className="text-center text-blue mt-2">   WardRobes </p>
              </div>
              ...
              <div className="single-box category-icon">
                ...
                <p className="text-center text-blue mt-2">   Chairs </p>
              </div>
            </div>
          </div>
        </div>
