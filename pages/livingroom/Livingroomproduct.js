...
function Livingeoomproduct ({ response }) {
  //ADD TO CART REDUX
  ...
  const [image, setImage] = useState(
    "/assets/images/ProductImage/Chicago-3-Seater-Crushed-Velvet-Silver-1-768x549.jpg"
  );
  const storageIcon = [
                        ...
                        <div className="scndbtn">
                          <div className="row">
                            ...
                            <div className="col-md-6">
                              ...
                              <Checkout addToCartHandler={addToCartHandler} price={total} title={bed?.product_name} base_price={bed?.price} type="livingroom" />
                            </div>
                          </div>
                        </div>
                      </div>
          ...
          >
                        ...
                        >
                          <div className="row pt-2">
                            <div className="col-md-2">
                              <img
                                src="/assets/images/ProductImage/Chicago-3-Seater-Crushed-Velvet-Black-768x549.jpg"
                                style={{ width: "94px" }}
                                alt=""
                              />
                            </div>
                            <div className="col-md-6 pl-8">
                              <h6
                                ...
                                className="completebed-heading"
                              >
                                <b>Chicago 3 Seater Crushed Velvet Black Sofa</b>
                              </h6>
                              <img
                                src="/assets/images/image/Group 480.png"
                                alt=""
                          ...
                          <div className="row pt-2">
                            ...
                            <div className="col-md-6 pl-8">
                              <h6
                                ...
                                className="completebed-heading"
                              >
                                <b>Lush 2 Seater Cord Sofa Range</b>
                              </h6>
                              <img
                                src="assets/images/image/Group 480.png"
                                alt=""
            ...
            sit amet blandit leo lobortis eget.
                    ...
                    <Accordion>
                      ...
                      <AccordionDetails>
                        <Typography>
                        Free delivery within 2-5 Working days within 120 miles of our post code WV14 7HZ. Once you’ve successfully placed your order, you’ll receive an order confirmation by email followed up by a call from the sales team within 2-3 working days, they will confirm your order and give you a confirmed delivery date.
Areas that are covered within 2-5 working days are – London, East Midlands, West Midlands, South Wales, Manchester, Yorkshire & surrounding postcodes.

Areas outside the above postcodes will take up to a further 2-5 working days.

We only deliver to UK Mainland.

Each order will only be dispatched once the order has been confirmed with the customer & the delivery date and approximate time has been given.

Please ensure you must leave a correct Contact number for our sales team to contact you, if we fail to reach you on a contact number your order will be put on hold until we hear from you to confirm.
It is the customers responsibility to make sure their details are up to date when placing an order, you will be prompted to accept out terms and condition before submitting the order.
All deliveries are free curb side only- this means we can only deliver to your door, for residents of flats or high raised building the item will be left at the ground floor only – our drivers are not permitted to deliver inside your homes, as this will void any cover or damages reported.

It is the customers responsibility to check the item in full before signing and accepting delivery.

Please note Delivery times can start from 5am onwards up to 10pm
                        </Typography>
                      </AccordionDetails>
                    </Accordion>
                    <Accordion>
                    ...
                    <Accordion>
                      ...
                      <AccordionDetails>
                      Once an order has been placed online or by phone, you agree to our terms and conditions, of the item being made to your specification, and if you decide to cancel your order a £30 administration charge will be liable to be paid, and this will be deducted from your order.
                      </AccordionDetails>
                    </Accordion>
...
If you are approved, then your refund will be processed, and a credit will automatically be applied to your credit card or original method of payment, within a 5-7 days depending on your bank
                      </AccordionDetails>
                    </Accordion>
                  </div>
                </div>
...
export default Livingeoomproduct;
...
export async function getServerSideProps(context) {
  ...
  const data = await axios.post(
    "http://localhost:3000/api/livingroom/getbeds",
    {
      method: "product_name",
      value: title,
    }
