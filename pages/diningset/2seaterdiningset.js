...
function Twoseaterdining({response}){
        ...
        <Header/>
          ...
          <div className="container">
              <div className="row text-center ">
                  <h1 className="font-weight-bold mt-6" style={{color:"#0e3f70"}}>2 Seater Dining Sets</h1>
          ...
          <div className="row">
            <div className="size-box">
              ...
              <div className="single-box category-icon">
                ...
                <p className="text-center text-blue mt-2">  6-Seater</p>
              </div>
              ...
              <div className="single-box category-icon">
                ...
                <p className="text-center text-blue mt-2">   8-Seater </p>
              </div>
...
export default Twoseaterdining;
export async function getServerSideProps(context) {
  ...
  const data = await axios.post(
   ...
   "http://localhost:3000/api/diningset/getbeds",
    {
      method: "category",
      value: '2 Seater Dining Set',
    }
  );
