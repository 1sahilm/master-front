...
function Sofa({response}) {
  ...
  console.log(response);    
    ...
    <Header/>
        {/* Banner Start */}
        <div className="section hero-slide-itemliving">
   <div className="container ">
      <div className="row">
         <div className="col-md-12">
            <div className="mt-10 For-margin">
               <h2 className="DivanPageH"><b>Modern and Stylish Living Room Furniture</b> </h2>
               <p className="mt-8" style={{color:"#141414",fontSize:"24px"}}>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed <br /> diam nonumy eirmod tempor invidunt ut labore et dolore <br /> magna aliquyam erat,</p>
