...
function Headboard({response}) {
  ...
  console.log(response);
    return (
      ...
      <Header/>
         {/* Banner Start */}
    <div className="section hero-slide-itemhead">
        <div className="container ">
            <div className="row">
                <div className="col-md-12">
                    <div className="mt-10 For-margin">
                    <h2 className="DivanPageH"><b>Hand Finished Mirrored Headboards  </b></h2>
                    <p className="mt-4" style={{color:"#141414",fontSize:"15px"}}>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed <br /> diam nonumy eirmod tempor invidunt ut labore et dolore <br /> magna aliquyam erat,</p>
                    <p className="mt-4" style={{color:"#141414",fontSize:"15px"}}>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed <br /> diam nonumy eirmod tempor invidunt ut labore et dolore <br /> magna aliquyam erat,</p>
                         <div style={{marginTop:"72px",marginBottom:"100px"}}>
    ...
    <div className="BodyMobileHeight" style={{backgroundColor:"#f3f3f8",height:"958px"}}> 
        ...
        <div className="container ">
            <div className="row">
                <div className="col-md-6">
                    <div className="mt-10 For-margin">
                    <h2 className="DivanPageH2" style={{marginTop:"10px",fontSize:"36px"}}><b>Latest Headboard Designs</b></h2>
