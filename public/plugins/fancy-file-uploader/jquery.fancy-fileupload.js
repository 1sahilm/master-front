...
(function($) {
	...
	$.fn.FancyFileUpload = function(options) {
		...
		var AddFile = function(uploads, e, data) {
			var inforow = $('<tr><td className="ff_fileupload_preview"><button className="ff_fileupload_preview_image" type="button"><span className="ff_fileupload_preview_text"></span></button><div className="ff_fileupload_actions_mobile"></div></td><td className="ff_fileupload_summary"><div className="ff_fileupload_filename"></div><div className="ff_fileupload_fileinfo"></div><div className="ff_fileupload_buttoninfo ff_fileupload_hidden"></div><div className="ff_fileupload_errors ff_fileupload_hidden"></div><div className="ff_fileupload_progress_background ff_fileupload_hidden"><div className="ff_fileupload_progress_bar"></div></div></td><td className="ff_fileupload_actions"></td></tr>');
