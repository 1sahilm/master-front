                                ...
                                return [
                                    _.node(
                                        ...
                                        (function( klasses ) {
                                            ...
                                            // Add the `today` className if needed.
                                            if ( nowObject.pick == targetDate.pick ) {
                                                klasses.push( settings.klass.now )
                                            }

                                            // Add the `selected` className if something's selected and the time matches.
                                            if ( isSelected ) {
                                                klasses.push( settings.klass.selected )
                                            }

                                            // Add the `highlighted` className if something's highlighted and the time matches.
                                            if ( isHighlighted ) {
                                                klasses.push( settings.klass.highlighted )
                                            }

                                            // Add the `disabled` className if something's disabled and the object matches.
                                            if ( isDisabled ) {
