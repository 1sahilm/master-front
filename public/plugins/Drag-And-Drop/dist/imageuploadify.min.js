...
(function($, window, document, undefined) {
	...
	$.fn.imageuploadify = function(opts) {
		...
		this.each(function() {
			...
			let totalFiles = [];
			let counter = 0;
			let dragbox = $(`<div className="imageuploadify well"><div className="imageuploadify-overlay"><i className="fa fa-picture-o"></i></div><div className="imageuploadify-images-list text-center"><i className="bx bxs-cloud-upload"></i><span className='imageuploadify-message'>Drag&Drop Your File(s)Here To Upload</span><button type="button"className="btn btn-default">or select file to upload</button></div></div>`);
			...
			const readingFile = (id, file) => {
				...
				let container = $(`<div className='imageuploadify-container'><button type='button'className='btn btn-danger bx bx-x'></button><div className='imageuploadify-details'><span>${file.name}</span><span>${file.type}</span><span>${file.size}</span></div></div>`);
				...
				if (file.type && file.type.search(/image/) != -1) {
					...
					let type = "<i className='fa fa-file'></i>";
					if (file.type.search(/audio/) != -1) {
						type = "<i className='fa fa-file-audio-o'></i>";
					} else if (file.type.search(/video/) != -1) {
						type = "<i className='fa fa-file-video-o'></i>";
					}
					fReader.onloadend = function(e) {
