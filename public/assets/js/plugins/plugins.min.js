...
! function(e, t) { "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = e || self).Swiper = t() }(this, (function() {
    ...
    var W = {
            ...
            renderSlide: function(e, t) { var i = this.params.virtual; if (i.cache && this.virtual.cache[t]) return this.virtual.cache[t]; var s = i.renderSlide ? m(i.renderSlide.call(this, e, t)) : m('<div className="' + this.params.slideClass + '" data-swiper-slide-index="' + t + '">' + e + "</div>"); return s.attr("data-swiper-slide-index") || s.attr("data-swiper-slide-index", t), i.cache && (this.virtual.cache[t] = s), s },
            appendSlide: function(e) {
                if ("object" == typeof e && "length" in e)
            ...
            render: function() {
                ...
                if (e.el && this.pagination.el && this.pagination.$el && 0 !== this.pagination.$el.length) {
                    var t = this.virtual && this.params.virtual.enabled ? this.virtual.slides.length : this.slides.length,
                        ...
                        s = "";
                    if ("bullets" === e.type) {
                        for (var a = this.params.loop ? Math.ceil((t - 2 * this.loopedSlides) / this.params.slidesPerGroup) : this.snapGrid.length, r = 0; r < a; r += 1) e.renderBullet ? s += e.renderBullet.call(this, r, e.bulletClass) : s += "<" + e.bulletElement + ' className="' + e.bulletClass + '"></' + e.bulletElement + ">";
        ...
        J = {
            ...
            init: function() {
                if (this.params.scrollbar.el) {
                    ...
                    0 === a.length && (a = m('<div className="' + this.params.scrollbar.dragClass + '"></div>'), s.append(a)), S(e, { $el: s, el: s[0], $dragEl: a, dragEl: a[0] }), i.draggable && e.enableDraggable()
                }
            },
        ...
        oe = {
            setTranslate: function() {
                var e, t = this.$el,
                    ...
                    u = 0;
                d.shadow && (h ? (0 === (e = i.find(".swiper-cube-shadow")).length && (e = m('<div className="swiper-cube-shadow"></div>'), i.append(e)), e.css({ height: a + "px" })) : 0 === (e = t.find(".swiper-cube-shadow")).length && (e = m('<div className="swiper-cube-shadow"></div>'), t.append(e)));
                for (var c = 0; c < s.length; c += 1) {
                    ...
                    if (y <= 1 && y > -1 && (u = 90 * v + 90 * y, n && (u = 90 * -v - 90 * y)), f.transform(T), d.slideShadows) {
                        ...
                        0 === C.length && (C = m('<div className="swiper-slide-shadow-' + (h ? "left" : "top") + '"></div>'), f.append(C)), 0 === S.length && (S = m('<div className="swiper-slide-shadow-' + (h ? "right" : "bottom") + '"></div>'), f.append(S)), C.length && (C[0].style.opacity = Math.max(-y, 0)), S.length && (S[0].style.opacity = Math.max(y, 0))
                    }
                }
            ...
            setTranslate: function() {
                for (var e = this.slides, t = this.rtlTranslate, i = 0; i < e.length; i += 1) {
                    ...
                    if (this.isHorizontal() ? t && (r = -r) : (o = l, l = 0, n = -r, r = 0), s[0].style.zIndex = -Math.abs(Math.round(a)) + e.length, this.params.flipEffect.slideShadows) {
                        ...
                        0 === d.length && (d = m('<div className="swiper-slide-shadow-' + (this.isHorizontal() ? "left" : "top") + '"></div>'), s.append(d)), 0 === h.length && (h = m('<div className="swiper-slide-shadow-' + (this.isHorizontal() ? "right" : "bottom") + '"></div>'), s.append(h)), d.length && (d[0].style.opacity = Math.max(-a, 0)), h.length && (h[0].style.opacity = Math.max(a, 0))
                    }
            ...
            setTranslate: function() {
                for (var e = this.width, t = this.height, i = this.slides, s = this.slidesSizesGrid, a = this.params.coverflowEffect, r = this.isHorizontal(), n = this.translate, l = r ? e / 2 - n : t / 2 - n, o = r ? a.rotate : -a.rotate, d = a.depth, h = 0, p = i.length; h < p; h += 1) {
                    ...
                    if (u.transform(T), u[0].style.zIndex = 1 - Math.abs(Math.round(f)), a.slideShadows) {
                        ...
                        0 === C.length && (C = m('<div className="swiper-slide-shadow-' + (r ? "left" : "top") + '"></div>'), u.append(C)), 0 === S.length && (S = m('<div className="swiper-slide-shadow-' + (r ? "right" : "bottom") + '"></div>'), u.append(S)), C.length && (C[0].style.opacity = f > 0 ? f : 0), S.length && (S[0].style.opacity = -f > 0 ? -f : 0)
                    }
                }
            },
...
! function(e) {
    e.fn.niceSelect = function(t) {
        function s(t) {
            t.after(e("<div></div>").addClass("nice-select").addClass(t.attr("className") || "").addClass(t.attr("disabled") ? "disabled" : "").attr("tabindex", t.attr("disabled") ? null : "0").html('<span className="current"></span><ul className="list"></ul>'));
            var s = t.next(),
                n = t.find("option"),
...
(function(t) { "function" == typeof define && define.amd ? define(["jquery"], t) : t(jQuery) })(function(t) {
        ...
        function() {
            ...
            t.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], function(e, i) {
                ...
                return this.queue(function() {
                    ...
                    l = l.map(function() { var i = t(this); return { el: i, start: e(this) } }), o = function() { t.each(s, function(t, e) { n[e] && a[e + "className"](n[e]) }) }, o(), l = l.map(function() { return this.end = e(this.el[0]), this.diff = i(this.start, this.end), this }), a.attr("className", r), l = l.map(function() {
                        var e = this,
                            i = t.Deferred(),
    ...
    t.extend(s.prototype, {
        ...
        _updateDatepicker: function(e) {
            ...
            r.length > 0 && o.apply(r.get(0)), e.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width(""), n > 1 && e.dpDiv.addClass("ui-datepicker-multi-" + n).css("width", a * n + "em"), e.dpDiv[(1 !== s[0] || 1 !== s[1] ? "add" : "remove") + "className"]("ui-datepicker-multi"), e.dpDiv[(this._get(e, "isRTL") ? "add" : "remove") + "className"]("ui-datepicker-rtl"), e === t.datepicker._curInst && t.datepicker._datepickerShowing && t.datepicker._shouldFocusInput(e) && e.input.trigger("focus"), e.yearshtml && (i = e.yearshtml, setTimeout(function() { i === e.yearshtml && e.yearshtml && e.dpDiv.find("select.ui-datepicker-year:first").replaceWith(e.yearshtml), i = e.yearshtml = null }, 0))
        },
        ...
        venobox: function(L) {
            ...
            return se.cb_init(ee), this.each(function() {
                ...
                ee.VBclose = function() { te() }, N.addClass("vbox-item"), N.data("framewidth", se.framewidth), N.data("frameheight", se.frameheight), N.data("border", se.border), N.data("bgcolor", se.bgcolor), N.data("numeratio", se.numeratio), N.data("gallItems", se.gallItems), N.data("infinigall", se.infinigall), N.data("overlaycolor", se.overlayColor), N.data("titleattr", se.titleattr), N.data("share", se.share), N.data("venobox", !0), N.on("click", function(k) {
                    ...
                    switch (ee.VBnext = function() { ie(z) }, ee.VBprev = function() { ie(B) }, w = N.data("overlay") || N.data("overlaycolor"), b = N.data("framewidth"), h = N.data("frameheight"), s = N.data("autoplay") || se.autoplay, r = N.data("border"), i = N.data("bgcolor"), P = !1, M = !1, m = !1, v = N.data("href") || N.attr("href"), u = N.data("css") || "", _ = N.attr(N.data("titleattr")) || "", H = N.data("share"), E = '<div className="vbox-preloader">', se.spinner) {
                        case "rotating-plane":
                            E += '<div className="sk-rotating-plane"></div>';
                            break;
                        case "double-bounce":
                            E += '<div className="sk-double-bounce"><div className="sk-child sk-double-bounce1"></div><div className="sk-child sk-double-bounce2"></div></div>';
                            break;
                        case "wave":
                            E += '<div className="sk-wave"><div className="sk-rect sk-rect1"></div><div className="sk-rect sk-rect2"></div><div className="sk-rect sk-rect3"></div><div className="sk-rect sk-rect4"></div><div className="sk-rect sk-rect5"></div></div>';
                            break;
                        case "wandering-cubes":
                            E += '<div className="sk-wandering-cubes"><div className="sk-cube sk-cube1"></div><div className="sk-cube sk-cube2"></div></div>';
                            break;
                        case "spinner-pulse":
                            E += '<div className="sk-spinner sk-spinner-pulse"></div>';
                            break;
                        case "chasing-dots":
                            E += '<div className="sk-chasing-dots"><div className="sk-child sk-dot1"></div><div className="sk-child sk-dot2"></div></div>';
                            break;
                        case "three-bounce":
                            E += '<div className="sk-three-bounce"><div className="sk-child sk-bounce1"></div><div className="sk-child sk-bounce2"></div><div className="sk-child sk-bounce3"></div></div>';
                            break;
                        case "circle":
                            E += '<div className="sk-circle"><div className="sk-circle1 sk-child"></div><div className="sk-circle2 sk-child"></div><div className="sk-circle3 sk-child"></div><div className="sk-circle4 sk-child"></div><div className="sk-circle5 sk-child"></div><div className="sk-circle6 sk-child"></div><div className="sk-circle7 sk-child"></div><div className="sk-circle8 sk-child"></div><div className="sk-circle9 sk-child"></div><div className="sk-circle10 sk-child"></div><div className="sk-circle11 sk-child"></div><div className="sk-circle12 sk-child"></div></div>';
                            break;
                        case "cube-grid":
                            E += '<div className="sk-cube-grid"><div className="sk-cube sk-cube1"></div><div className="sk-cube sk-cube2"></div><div className="sk-cube sk-cube3"></div><div className="sk-cube sk-cube4"></div><div className="sk-cube sk-cube5"></div><div className="sk-cube sk-cube6"></div><div className="sk-cube sk-cube7"></div><div className="sk-cube sk-cube8"></div><div className="sk-cube sk-cube9"></div></div>';
                            break;
                        case "fading-circle":
                            E += '<div className="sk-fading-circle"><div className="sk-circle1 sk-circle"></div><div className="sk-circle2 sk-circle"></div><div className="sk-circle3 sk-circle"></div><div className="sk-circle4 sk-circle"></div><div className="sk-circle5 sk-circle"></div><div className="sk-circle6 sk-circle"></div><div className="sk-circle7 sk-circle"></div><div className="sk-circle8 sk-circle"></div><div className="sk-circle9 sk-circle"></div><div className="sk-circle10 sk-circle"></div><div className="sk-circle11 sk-circle"></div><div className="sk-circle12 sk-circle"></div></div>';
                            break;
                        case "folding-cube":
                            E += '<div className="sk-folding-cube"><div className="sk-cube1 sk-cube"></div><div className="sk-cube2 sk-cube"></div><div className="sk-cube4 sk-cube"></div><div className="sk-cube3 sk-cube"></div></div>'
                    }
                    return E += "</div>", D = '<a className="vbox-next">' + se.htmlNext + '</a><a className="vbox-prev">' + se.htmlPrev + "</a>", I = '<div className="vbox-title"></div><div className="vbox-left"><div className="vbox-num">0/0</div></div><div className="vbox-close">' + se.htmlClose + "</div>", '<div className="vbox-share"></div>', l = '<div className="vbox-overlay ' + u + '" style="background:' + w + '">' + E + '<div className="vbox-container"><div className="vbox-content"></div></div>' + I + D + '<div className="vbox-share"></div></div>', e("body").append(l).addClass("vbox-open"), e(".vbox-preloader div:not(.sk-circle) .sk-child, .vbox-preloader .sk-rotating-plane, .vbox-preloader .sk-rect, .vbox-preloader div:not(.sk-folding-cube) .sk-cube, .vbox-preloader .sk-spinner-pulse").css("background-color", se.spinColor), y = e(".vbox-overlay"), d = e(".vbox-container"), n = e(".vbox-content"), a = e(".vbox-left"), t = e(".vbox-num"), o = e(".vbox-share"), c = e(".vbox-title"), (O = e(".vbox-preloader")).show(), S = "top" == se.titlePosition ? "bottom" : "top", o.css(S, "-1px"), o.css({ color: se.titleColor, fill: se.titleColor, "background-color": se.titleBackground }), c.css(se.titlePosition, "-1px"), c.css({ color: se.titleColor, "background-color": se.titleBackground }), e(".vbox-close").css({ color: se.closeColor, "background-color": se.closeBackground }), a.css(se.numerationPosition, "-1px"), a.css({ color: se.numerationColor, "background-color": se.numerationBackground }), e(".vbox-next span, .vbox-prev span").css({ "border-top-color": se.arrowsColor, "border-right-color": se.arrowsColor }), n.html(""), n.css("opacity", "0"), y.css("opacity", "0"), L(), y.animate({ opacity: 1 }, 250, function() { "iframe" == N.data("vbtype") ? he() : "inline" == N.data("vbtype") ? pe() : "ajax" == N.data("vbtype") ? be() : "video" == N.data("vbtype") ? ke(s) : (n.html('<img src="' + v + '">'), ge()), se.cb_post_open(N, U, z, B) }), e("body").keydown(ae), e(".vbox-prev").on("click", function() { ie(B) }), e(".vbox-next").on("click", function() { ie(z) }), !1
                });
                var oe = ".vbox-overlay";
                ...
                function be() { e.ajax({ url: v, cache: !1 }).done(function(e) { n.html('<div className="vbox-inline">' + e + "</div>"), ge() }).fail(function() { n.html('<div className="vbox-inline"><p>Error retrieving contents, please retry</div>'), me() }) }

                function he() { n.html('<iframe className="venoframe" src="' + v + '"></iframe>'), me() }
                ...
                function ke(e) {
                    ...
                    "vimeo" == i.type ? s = "https://player.vimeo.com/video/" : "youtube" == i.type && (s = "https://www.youtube.com/embed/"), n.html('<iframe className="venoframe vbvid" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="autoplay" frameborder="0" src="' + s + i.id + a + '"></iframe>'), me()
                }

                function pe() { n.html('<div className="vbox-inline">' + e(v).html() + "</div>"), me() }
...
;(function($) {
    ...
    $.fn.LineProgressbar = function(options) {
        ...
        return this.each(function(index, el) {
            // Markup
            $(el).html(
                '<div className="progressbar"><div className="proggress"></div><div className="percentCount"></div></div>'
            )
